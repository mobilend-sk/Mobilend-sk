				...
				<div className="AboutHero__container">
					...
					<div className="AboutHero__content">
						...
						<div className="AboutHero__text">
							<p>
								Sme online technický obchod špecializujúci sa na najnovšie smartfóny a tablety Samsung a Xiaomi
								(modely 2024) spolu s oficiálnymi príslušenstvami. Všetky naše produkty sú úplne nové,
