...
export async function generateMetadata() {
	return {
		...
		description: 'Kompletný katalóg mobilných telefónov. iPhone, Samsung Galaxy, Xiaomi a ďalšie značky za najlepšie ceny s doručením zadarmo. Porovnajte ceny a vyberte si.',
